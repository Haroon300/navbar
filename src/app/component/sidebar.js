    ...
    <div>
      <div>
        <nav
          ...
          bg-[#000026] shadow-[0_4px_12px_0_rgba(0,0,0,0.07),_0_2px_4px_rgba(0,0,0,0.05)] 
        ...
        >
          ...
          >
            <li class="relative flex justify-center items-center">
              <span class="[&>svg]:h-8 [&>svg]:w-8 [&>svg]:text-[#535CE7] dark:[&>svg]:text-[#535CE7]">
                <MdDashboard />
              </span>
              <span
                class="group-[&[data-te-sidenav-slim-collapsed='true']]:data-[te-sidenav-slim='false']:hidden text-[#BEC9E2]
                  font-bold italic"
            ...
            <li class="relative">
              <a
                ...
                ase-linear hover:bg-cyan-500 hover:bg-opacity-40 hover:text-inherit hover:outline-none 
                focus:bg-cyan-800 focus:bg-opacity-50
                focus:text-inherit focus:outline-none active:bg-cyan-800 active:text-inherit 
                ...
                dark:text-[#BEC9E2] dark:hover:bg-white/10 dark:focus:bg-white/10 
                dark:active:bg-white/10"
                data-te-sidenav-link-ref
              >
                <span class="[&>svg]:h-6 [&>svg]:w-6 [&>svg]:text-[#535CE7] dark:[&>svg]:text-[#535CE7]">
                <SiHomebridge />
                </span>
                <span
                  class="group-[&[data-te-sidenav-slim-collapsed='true']]:data-[te-sidenav-slim='false']:hidden text-[#BEC9E2]
              ...
              >
                <li class="relative">
                  <a
                    ...
                    pr-6 text-[0.78rem]  outline-none transition duration-300 ease-linear hover:bg-cyan-500 hover:bg-opacity-40 
